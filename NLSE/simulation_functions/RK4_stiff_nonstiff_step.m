function u = RK4_stiff_nonstiff_step(simulation_params)
%
%u = RK4_stiff_nonstiff_step(simulation_params)
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  simulation_params: structure with data for simulation
%
%       u  =  the Fourier modes ([0:N,-N:-1]) that we seek to advance
%
%       t  =  current time
%
%      dt  =  timestep
...
s = simulation_params.s;
ns = simulation_params.ns;
As = simulation_params.As;
